      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <p className="text-gray-700">
            ...
            and adapt the content displayed on CareCrew, provided you have given
            your consent Art. 6 Abs. S.1 lit. a DSGVO in conjunction with § 25
            Abs. 1 TTDSG. You give your consent by clicking the "Allow" button.
            If you click the "Reject" button, only necessary cookies will be
            used. You can revoke your consents and set individual preferences by
            clicking on "Cookie Settings". The cookie settings can be accessed
            via the link "Cookie Policy and Consent" displayed at the bottom of
            every page on our website.
          </p>
          <div className="flex flex-row gap-4 items-center justify-center">
            <div
              onClick={closeModal}
              className="px-5 py-2 bg-blue-500 hover:cursor-pointer duration-300 transition ease-in-out hover:bg-blue-600 uppercase rounded-lg text-white font-medium"
            >
              Accept
            </div>
            <div
              onClick={closeModal}
              className="px-5 py-2 bg-red-500 hover:cursor-pointer duration-300 transition ease-in-out hover:bg-red-600 uppercase rounded-lg text-white font-medium"
            >
              Reject
            </div>
          </div>
